...
| `# Group:` | Нет | Классификация группы пакета |
...
| Поле | Обязательно | Описание |
|---|---|---|
| `# Packageurl:` | Да | URL исходного кода. Для tarball-архивов: `https://...tar.gz`. Для git: `git+https://...` |
| `# Packageref:` | Только для git | Ссылка на тег, коммит или ветку git |
